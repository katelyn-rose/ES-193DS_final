...
However, there is a simpler model to explain variation in the total number of seeds. The best fitting model we found was the weight of seeds and total number of inflorescences. This model also makes biological sense; the total number of inflorescences would affect seed quantity because the number of seeds produced by a plant is dependent upon the number of flowers produced and pollinated. Plants which produce heavier seeds are likely bigger and healthier, therefore likely to produce a greater quantity of seeds as well. 
